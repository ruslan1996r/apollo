...
export type CountryDetails = { __typename: 'Query', country?: Types.Maybe<{ __typename: 'Country', code: string, name: string, native: string, capital?: Types.Maybe<string>, emoji: string, phone: string, currency?: Types.Maybe<string>, languages: Array<{ __typename: 'Language', rtl: boolean, code: string, name?: Types.Maybe<string>, native?: Types.Maybe<string> }>, continent: { __typename: 'Continent', code: string, name: string, countries: Array<(
        { __typename: 'Country', code: string }
        & CountryCardCountry
      )> }, states: Array<{ __typename: 'State', code?: Types.Maybe<string>, name: string }> }> };
